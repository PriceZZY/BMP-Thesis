...
Seeds are fixed: main MC uses seeds 1000-1999; variance decomposition uses 8000-8999. Two runs of the *same* code with the same seeds give identical output.
